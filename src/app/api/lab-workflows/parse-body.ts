...
import { NewStepInput } from "@/lib/lab-workflows-store";

const VALID_KEYS = new Set(STEP_PRESETS.map((p) => p.key));
...
export function parseSteps(body: unknown): NewStepInput[] | { error: string } {
