...
import {
  addBioNotesBlock,
  listBioNotesBlocks,
  reorderBioNotesBlocks,
} from "@/lib/project-bio-notes-store";
...
export async function GET(
  ...
  try {
    ...
    const blocks = await listBioNotesBlocks(id);
...
export async function POST(
  ...
  try {
    ...
    const block = await addBioNotesBlock(id, title, content);
...
// PATCH /api/lab-workflows/[id]/steps.
export async function PATCH(
  ...
  try {
    ...
    await reorderBioNotesBlocks(id, orderedBlockIds);
